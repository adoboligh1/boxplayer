...
const APIURL = ("https://tm01.ghanacloud.ga/radio/8260/radio.mp3");
...
function getStreamingData() {
    ...
    xhttp.open('GET', 'api.php?url=' + APIURL + '&streamtype=' + STREAMING_TYPE + '&historic=' + HISTORIC + '&next=' + NEXT_SONG + '&t=' + d.getTime(), true);
    xhttp.send();
}
